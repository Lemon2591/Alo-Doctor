...
function BookDateContent() {
    ...
    const [healthIsues, setHealthIsues] = useState ('')
    ...
    const handleHealthIsues = (e) => {
        setHealthIsues(e.target.value)
    }
   ...
   <>
    <div className='Siler-Patient'>
        ...
        <div className='title-book-doctor'>
            <p>ĐẶT LỊCH KHÁM VỚI BÁC SĨ RIÊNG TẠI NHÀ</p>
        </div>
                ...
                <div className='form-add'>
                    <form onSubmit={sendData}> 
                        ...
                        <div className='format-form-info d-flex d-flex1' >
                            ...
                            <div className="form-outline mb-4 col-md-6">
                                <label className="form-label" for="Location">Chọn nơi khám</label>
                                
                                <select onChange={handleLocation} value={time} name='location' type="location" id="form3Example4cdg" className="form-control form-control-lg custom-select" placeholder='Dân tộc'>
                                    <option value='0'>Chọn</option>
                                    <option value="Trung tâm INFI-HEALTH số 422 Vĩnh Hưng, Thanh Trì, Hoàng Mai, HN "> Trung tâm INFI-HEALTH số 422 Vĩnh Hưng, Thanh Trì, Hoàng Mai, HN </option>
                                    <option value="Trung tâm INFI-HEALTH Cầu Giấy, HN ">Trung tâm INFI-HEALTH Cầu Giấy, HN </option>
                                    <option value="Trung tâm INFI-HEALTH Nam Từ Liêm, HN ">Trung tâm INFI-HEALTH Nam Từ Liêm, HN </option>
                                    <option value="Trung tâm INFI-HEALTH Đông Anh, HN ">Trung tâm INFI-HEALTH Đông Anh, HN </option>
                                    <option value="Trung tâm INFI-HEALTH Ba ĐÌnh, HN ">Trung tâm INFI-HEALTH Ba ĐÌnh, HN </option>
                        ...
                        <div className="form-outline healthIsues">
                            <label className="form-label" for="healthIsues" >Vấn đề sức khoẻ</label>
                            <input name='healthIsues' type="text" id="form3Example1cg" className="form-control form-control-lg" placeholder='Nhập vấn đề sức khoẻ'
                            required 
                            value={healthIsues}
                            onChange={handleHealthIsues}
                            />
                        </div>
...
export default BookDateContent