...
import './NavUsingInstructions.css';
...
class NavUsingInstructions extends Component {
    render() {
        return (
            <>
                ...
                <div className='nav-content'>
                    ...
                    <div className='nav-list-link'>
                        <ul className='list-item-all'>
                             ...
                             <li className='nav-item  active-bar'><NavLink className='nav-item-link' to='/UsingInstructions'>HƯỚNG DẪN SỬ DỤNG</NavLink></li>
...
export default NavUsingInstructions;