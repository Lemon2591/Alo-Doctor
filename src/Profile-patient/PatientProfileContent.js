            ...
            <div className="add-info">
              ...
              {showAddProfile ? (
                ...
                >
                  ...
                  <div>Chưa có hồ sơ, thêm hồ sơ tại đây !</div>
                </div>
              ) : null}
              {showProfile ? (
                    ...
                    <div className="format-form-info d-flex ">
                      ...
                      <div className="form-outline mb-4 col-md-6">
                        ...
                        <input
                          ...
                          id="form3Example3cg"
                          className="form-control form-control-lg"
                          placeholder="Vui lòng nhập số điệnh thoại"
                          required
                    ...
                    <div className="format-form-info d-flex">
                      <div className="form-outline mb-4 col-md-6">
                        ...
                        <input
                          ...
                          id="form3Example4cg"
                          className="form-control form-control-lg"
                          placeholder="Email ( Nhận hồ sơ điện tử )"
                          required
                          value={value.mail}
                          onChange={handleChange}
                        />
                    ...
                    <div className="format-form-info d-flex">
                      <div className="form-outline mb-4 col-md-6">
                        ...
                        <input
                          ...
                          id="form3Example4cg"
                          className="form-control form-control-lg"
                          placeholder="Địa chỉ Email thân nhân"
                          required
